...
export default function ShiftWarningModal({ warnings, confirmLabel, onClose, onConfirm }) {
  return (
    <div className="fixed inset-0 z-50 bg-black/30 flex items-center justify-center p-4" onClick={onClose}>
      <div className="max-w-md w-full card elevated p-8 relative" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2>Confirm this shift?</h2>
        </div>
        <p className="text-[13px] mb-4" style={{ color: "var(--ink-mute)" }}>
          This shift conflicts with information recorded for the employee.
        </p>
